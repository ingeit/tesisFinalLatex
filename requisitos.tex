...
\begin{itemize}
    \item En las salidas de campo, poder generar registros con información sensible (imágenes capturadas con la cámara de fotos, coordenadas obtenidas mediante el GPS integrado, entre otras)  para la futura gestión por parte de los administradores.
    ...
    \item Los administradores podrán gestionar los registros previamente creados y guardados en el servidor mediante el sistema desde un navegador web (Google Chrome, Internet Explorer, Mozilla, etc).
    \item Los administradores podrán ver el renderizado de un mapa (Google Maps) con los trazos en donde se muestre la información que ellos requieren.
\end{itemize}
 

El sistema debe ser seguro, escalable, de fácil mantenimiento y muy simple de usar utilizando sólo interfaces táctiles para los usuarios finales.
