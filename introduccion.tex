...
El proyecto surge del convenio de la cátedra de Sistemas con micro procesadores de la Facultad de Ciencias Exactas y Tecnología de la UNT, con la Facultad de Ciencias Naturales e Instituto Miguel Lillo, para le desarrollo de una solución tecnológica para el control del estado de contaminación del agua en la provincia de Tucumán.
...
Generar registros digitales de muestras realizadas por los alumnos en salidas de campos.
