	...
	\section{Interfaz de usuario}
		\begin{itemize}
			...
			\item \subsection{Sistema de gestion WEB}
				...
				\subsection{Lista de registros global}
					\begin{figure}
						\centering
				...
				\subsection{Iniciar Sesion}
					\begin{figure}
						\centering
							\includegraphics[width=0.6\textwidth]{Screenshots/web/pagina-producto.png}
									%%Me parece que queda mejor sin el hfill
									%\hfill
				...
				\subsection{Iniciar Sesion}
					\begin{figure}
						\centering
							\includegraphics[width=0.6\textwidth]{Screenshots/web/listado-ventas.png}
									%%Me parece que queda mejor sin el hfill
									%\hfill
